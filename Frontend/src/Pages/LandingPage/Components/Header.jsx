          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <a
                  href="/signup"
                  className="bg-gradient-to-r from-blue-600 to-pruple-600 text-white px-6 py-2 rounded-lg font-medium bg-gradient-to-r from-blue-700 to-pruple-700 transition-all duration-300 shadow-sm hover:shadow-md"
                >
                  Signup
                </a>
              </>
